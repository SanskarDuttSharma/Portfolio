package com.example.porfolioapp.team;
...
public class TeamFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TeamItem item2 = new TeamItem("Jany Doe",getString(R.string.lorem_text2),R.drawable.uservoyager);
        TeamItem item3 = new TeamItem("Janardan Doe",getString(R.string.lorem_text2),R.drawable.userspace);
